...
export default function HighlightComponent({entities}: {entities: Entity[] }){
    ...
    function highlighting_data(text: string){
        ...
        if(text.match(patterns.date)){
            return "text-green-900"

        }
        else if(text.match(patterns.medical)){
            return "text-purple-900"

        }
        else if(text.match(patterns.name) || text.match(patterns.place)){
            return "text-blue-900"

        }
        else if(text.match(patterns.money)){
